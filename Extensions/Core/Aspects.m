...
static id aspect_add(id self, SEL selector, AspectOptions options, id block, NSError **error) {
    ...
    // ⚠️ Block captures an autoreleasing out-parameter, which may result in use-after-free bugs
    // aspect_performLocked 中 block 是 nonescape 被直接调用的，不会出现警告中的问题，故此处忽略警告。
